...
<main class="app-content">
    ...
    <?php endif; ?>
    <a class="btn btn-primary" href="index.php?controller=mainpic&action=aboutUpdate">Thay đổi Ảnh chính</a>
    ...
    <?php if (!empty($mainPic)):?>
        <table class="table">
            ...
            <tr>
                ...
                <td><img width="80px" src="assets/imguploads/about_mainpic/<?php echo $mainPic[0]['name']?>"></td>
