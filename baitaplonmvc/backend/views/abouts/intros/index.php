<?php require_once "views/layouts/header.php"; ?>
    <main class="app-content">
        ...
        <br>
        <br>
        <form method="post" enctype="multipart/form-data" action="index.php?controller=intro&action=deleteChecked">
            ...
            <table class="table">
                ...
                <?php if (!empty($intro)): ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo date('d-m-Y H:i:s',strtotime($intro[0]['created_at']));?></td>
                            <td>
                                <?php
                            ...
                            <td>
                                <!--        --><?php
                                $urlDetail="index.php?controller=intro&action=detail&id=".$intro[0]['id'];
                                $urlUpdate="index.php?controller=intro&action=update&id=".$intro[0]['id'];
