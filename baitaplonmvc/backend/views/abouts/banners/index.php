...
<main class="app-content">
    ...
    <a class="btn btn-primary" href="index.php?controller=banner&action=aboutCreate">Thêm mới biểu ngữ</a>
    <a class="btn btn-danger" href="index.php?controller=banner&action=aboutDeleteAll" onclick="return confirm('Bạn có chắc muốn xóa hết tất cả dữ liệu không?')">Xóa tất cả dữ liệu </a>

    <form method="post" enctype="multipart/form-data" action="index.php?controller=banner&action=AboutDeleteChecked">
            ...
            <?php if (!empty($banners)): ?>
                <?php foreach ($banners as $banner): ?>
                    <tr>
                        ...
                        <td>
                            <!--        --><?php
                            $urlDetail="index.php?controller=banner&action=aboutDetail&id=".$banner['id'];
                            $urlUpdate="index.php?controller=banner&action=aboutUpdate&id=".$banner['id'];
                            $urlDelete="index.php?controller=banner&action=aboutDelete&id=".$banner['id'];
                            //        ?>
