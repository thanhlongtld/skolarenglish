    ...
    <main class="app-content">
        ...
        <form class="form-group" method="post" enctype="multipart/form-data" action="">
            ...
            <input class="form-control" type="text" name="courseName"
                   value="<?php echo isset($_POST['courseName']) ? $_POST['courseName'] : $course['name'] ?>">
            ...
            <input class="form-control" type="number" name="courseNumberStudent" min="0" max="1000"
                   value="<?php echo isset($_POST['courseNumberStudent']) ? $_POST['courseNumberStudent'] : $course['number_of_student'] ?>">
            ...
            <input class="form-control" type="number" name="courseNumberStudentMax" min="0" max="1000"
                   value="<?php echo isset($_POST['courseNumberStudentMax']) ? $_POST['courseNumberStudentMax'] : $course['max_number_student'] ?>">
            <label style="font-weight: bold">Teacher:</label>
            <input class="form-control" type="text" name="courseTeacher"
                   value="<?php echo isset($_POST['courseTeacher']) ? $_POST['courseTeacher'] : $course['teacher'] ?>">
            <label style="font-weight: bold">Avatar:</label>
            <input type="file" class="form-control" name="courseAvatar"  >
            <?php if (!empty($course['avatar'])): ?>
                <img
                        src="assets/imguploads/courseAvatar/<?php echo $course['avatar'] ?>"
                        width="80px" />
            <?php endif; ?>
            <br>
            <?php
            ...
            $selectedTypeSmall = '';
            $selectedTypeThin = '';
            $selectedType=isset($_POST['courseType'])? $_POST['courseType']: $course['type'];
            ...
            <textarea id="contact-description" class="form-control" name="courseDescription" autofocus>
                <?php echo isset($_POST['courseDescription']) ? $_POST['courseDescription']: $course['description'] ?>
            </textarea>

            <?php
            $selectedStatusEnabled = '';
            $selectedStatusDisabled = '';
            $statusCourse= isset($_POST['courseStatus'])? $_POST['courseStatus'] : $course['status'];
